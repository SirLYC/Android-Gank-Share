...
//     * 数据源
//     */
//    protected List<GankItem> mData = new ArrayList<>();
//
...
//                List<GankItem> list = new Gson().fromJson(json, Results.class).resultItems;
...
//    }
//
//    protected void collect(final GankItem item, final View v){
...
//                final GankItem item = mData.get(pos);
...
//    }
//
//    private void saveImgWithPermissionCheck(GankItem i) {
...
//                    GankItem item = mData.get(itemNow);
