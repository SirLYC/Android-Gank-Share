## 干货集中营Gank.io客户端
## 该分支已废弃
- kotlin-mvvm-refactor分支为kotlin重构分支，使用了Android架构组件，mvvm架构
- master分支已经废弃，不会再更新
- master分支为早期学习作品，代码结构不严谨，有点乱
- kotlin分支实现了原先有的基本功能，然后搜索、发现、我的等功能不准备再写了，因为逻辑与已经写过的很多功能差不多，没有额外的精力去做重复的工作。
- 如果有兴趣欢迎欢迎fork继续完善。。。
- 准备写一个flutter项目，可能继续使用这个接口。。。（或许更复杂的接口去写一个完整的flutter项目？）
### 下载地址
[百度网盘](http://pan.baidu.com/s/1dFiZdcP)
>> 如果网盘挂了可以随时联系我
