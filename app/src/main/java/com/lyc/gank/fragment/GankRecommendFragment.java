...
//                .map(new Function<RecommendResults, List<GankItem>>() {
//                    @Override
//                    public List<GankItem> apply(RecommendResults recommendResults) throws Exception {
//                        return recommendResults.recommend.merge();
//                    }
//                })
//                .map(new Function<List<GankItem>, Integer>() {
//                    @Override
//                    public Integer apply(List<GankItem> list) throws Exception {
